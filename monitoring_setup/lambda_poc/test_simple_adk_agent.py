"""
Test the simple ADK agent (no direct Lambda forwarding)
Works like basic-gcp-agent-working
"""
import vertexai
...
ENGINE_ID = "8213677864684355584"  # Simple ADK agent (Cloud Logging only)
STAGING_BUCKET = f"gs://{PROJECT_ID}-reasoning-engine"

print("=" * 60)
print("Testing Simple ADK Agent (Cloud Logging Only)")
print("=" * 60)
...
# Load engine
print("[1/4] Loading Simple ADK Agent...")
...
print(f"  Log capture: {result1['log_capture']}")
print()
...
print("  - Automatic Cloud Logging capture")
print()
print("Logs flowing to AWS Lambda via Cloud Logging:")
print("  Reasoning Engine -> Cloud Logging -> Log Sink -> Pub/Sub -> Lambda")
print()
print("Check logs in 1-2 minutes:")
print("  MSYS_NO_PATHCONV=1 aws logs tail /aws/lambda/gcp-pubsub-test --since 5m --region us-east-1")
print()
print("Works exactly like basic-gcp-agent-working!")
print()
